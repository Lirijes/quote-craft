          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/60 text-muted-foreground text-xs">
                ...
                <th className="text-center p-3 font-medium w-20">Image</th>
      ...
      <td className="p-2 text-center">
        ...
        {product.imageUrl ? (
          <button
            ...
            className="mx-auto block rounded overflow-hidden border border-border hover:border-primary transition-colors"
          >
